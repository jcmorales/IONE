...
<!--Nombre del documento: ManifestacionAfectacionUO -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'ManifestacionAfectacionUO'
		};
		var varArea = {};
		var varAreas = [];
		for(var i = 1; i <= $('#hdncontador_Area').val(); i++) {
...
<h3 id="lblManifestacion/AfectacionUO">Manifestacion/AfectacionUO</h3>
