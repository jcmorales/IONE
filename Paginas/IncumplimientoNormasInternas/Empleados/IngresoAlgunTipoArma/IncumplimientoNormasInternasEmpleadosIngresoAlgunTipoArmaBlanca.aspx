...
<!--Nombre del documento: IncumplimientoNormasInternasEmpleadosIngresoAlgunTipoArmaBlanca -->
...
async: false,
	...
	function obtenerEquipos(identificador, campo) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('DN_Equipo')/Items?$select= Numero,Equipo&$orderby=ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
...
async: false,
	...
	function bloquear(can_ubi, can_equi, can_per) {
		...
		$('#txtUbicacion2').prop('disabled', true);
		$('#txtMotivo2').prop('disabled', true);
	...
	alert('No se puede continuar porque el campo * Equipos está vacío');
		...
		if($('#txtUbicacion2').val() === ''){
			$('#txtUbicacion2').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Ubicacion está vacío');
			return false;
		}else{
			$('#txtUbicacion2').css('border-color', '#D8D8D8');
		}
		if($('#txtMotivo2').val() === ''){
			$('#txtMotivo2').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Motivo está vacío');
			return false;
		}else{
			$('#txtMotivo2').css('border-color', '#D8D8D8');
		}
	...
	function obtener() {
		...
		var e = {
			...
			'Ubicacion': $('#txtUbicacion2').val(),
			'Motivo': $('#txtMotivo2').val(),
			...
			'NombreReporte':'IncumplimientoNormasInternasEmpleadosIngresoAlgunTipoArmaBlanca'
		};
	...
	function colocar(datos) {
		...
		$('#txtUbicacion2').val(datos.Ubicacion),
		$('#txtMotivo2').val(datos.Motivo),
...
<h3 id="lblIncumplimientoNormasInternasEmpleadosIngresoAlgunTipoArmaBlanca">IncumplimientoNormasInternasEmpleadosIngresoAlgunTipoArmaBlanca</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblUbicacion2'  >* Ubicacion</label>
				<input class='form-control' idvariabledepende ='Ubicacion2' maxlength='100' id='txtUbicacion2' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMotivo2'  >* Motivo</label>
				<input class='form-control' idvariabledepende ='Motivo2' maxlength='100' id='txtMotivo2' type='text'  />
			</div>
		</div>
	</div>
	<div id="ctHoraEvento" class='container'>
