...
<!--Nombre del documento: PerdidasPatrimonialesUnidadOperativaMaestros -->
...
async: false,
	...
	function obtenerDatos(identificador) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('TR_PerdidasPatrimoniales')/Items?$select= HoraOcurre,HoraFinaliza,HoraReportanProteccion,NombrePersonaReportaProteccion,PuestoPersonaReportaProteccion,Motivo,NoDelincuentes,NoAveriguacionPrevia,Detenidos,StatusCaja,Calle,Numero,Colonia,MunicipioDelegacion,Estado,CodigoPostal,MontoEfectivo,MontoRecuperacion,MontoAproximadoEfectivo,OtrosMontos,MontoTotal,RetiroValores,ObservacionesInformacionAdiciona,NombreReporte,NumeroReporte,Title&$orderby = ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'PerdidasPatrimonialesUnidadOperativaMaestros'
		};
...
<h3 id="lblPerdidasPatrimonialesUnidadOperativaMaestros">PerdidasPatrimonialesUnidadOperativaMaestros</h3>
