...
<!--Nombre del documento: AlarmaActivacion -->
...
async: false,
	...
	function obtenerDatos(identificador) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('TR_Alarma')/Items?$select= HoraOcurre,HoraFinaliza,HoraReportanProteccion,NombrePersonaReportaProteccion,PuestoPersonaReportaProteccion,Tipo1,NombreQuienProporcionaApoyo,PuestoQuienProporcionaApoyo,PuestoPersonaAutoriza,NombreQuienAutoriza,TipoAsesoria,ObservacionesInformacionAdiciona,NombreReporte,NumeroReporte,Title&$orderby = ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'AlarmaActivacion'
		};
...
<h3 id="lblActivación">Activación</h3>
