...
<!--Nombre del documento: CajaSeguridadUOAlertaSatelital -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'CajaSeguridadUOAlertaSatelital'
		};
		var varEquipos = {};
		var varEquiposs = [];
		for(var i = 1; i <= $('#hdncontador_Equipos').val(); i++) {
...
<h3 id="lblCajaSeguridadUOAlertaSatelital">CajaSeguridadUOAlertaSatelital</h3>
