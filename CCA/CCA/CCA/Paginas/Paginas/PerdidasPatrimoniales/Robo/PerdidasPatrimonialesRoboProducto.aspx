...
<!--Nombre del documento: PerdidasPatrimonialesRoboProducto -->
...
EliminarDatosArea($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarDatosB(datos, clientContext) {
		...
		guardarReporteAreaB(datos[3][i], info.Identificador, info.NumeroReporte, info.Estatus, clientContext);
		}
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'PerdidasPatrimonialesRoboProducto'
		};
...
<h3 id="lblPerdidasPatrimonialesRoboProducto">PerdidasPatrimonialesRoboProducto</h3>
