...
EliminarDatosProducto($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function gotAccount(sender, args) {
		...
		var cRetiroValores= document.getElementById('LstRetiroValores_');
		llenarObjSelect(cRetiroValores, vRetiroValores);
	}
...
async: false,
	...
	function bloquear(can_ubi, can_equi, can_per) {
		...
		$('#LstRetiroValores_').prop('disabled', true);
	...
	alert('No se puede continuar porque el campo * Monto aproximado en producto está vacío');
		...
		if($('#LstRetiroValores_ option:selected').text() === '...' || $('#LstRetiroValores_ option:selected').text() === '') {
			$('#LstRetiroValores_').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Retiro de valores está vacío');
			return false;
		}else{
			$('#LstRetiroValores_').css('border-color', '#D8D8D8');
		}
	...
	function obtener() {
		...
		var e = {
			...
			'RetiroValores': $('#LstRetiroValores_ option:selected').text(),
	...
	function colocar(datos) {
		...
		vRetiroValores = datos.RetiroValores;
...
<h3 id="lblPerdidasPatrimonialesUnidadOperativaEstudiantes">PerdidasPatrimonialesUnidadOperativaEstudiantes</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblRetiroValores'  >* Retiro de valores</label>
				<select class='form-control' id='LstRetiroValores_'   >
					<option></option>
				</select>
			</div>
		</div>
