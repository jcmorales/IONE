...
<!--Nombre del documento: PerdidasPatrimonialesSociopoliticoRutaEstudiantes -->
...
EliminarDatosClientes($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarDatosB(datos, clientContext) {
		...
		guardarReporteProductoB(datos[3][i], info.Identificador, info.NumeroReporte, info.Estatus, clientContext);
		}

		for(var i = 0; i<datos[4].length; i++) {
		guardarReporteClientesB(datos[4][i], info.Identificador, info.NumeroReporte, info.Estatus, clientContext);
		}
...
async: false,
	...
	alert('No se puede continuar porque el campo Número de Delincuentes está vacío');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Lugar de resguardo está vacío');
			return false;
		}else{
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'PerdidasPatrimonialesSociopoliticoRutaEstudiantes'
		};
...
<h3 id="lblPerdidasPatrimonialesSociopoliticoRutaEstudiantes">PerdidasPatrimonialesSociopoliticoRutaEstudiantes</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblNoDelincuentes'  >Número de Delincuentes</label>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control moneda' onblur="sumarMonto()" idvariabledepende ='MontoAproximadoenproducto' maxlength='25' id='txtMontoAproximadoenproducto' type='text'  />
			</div>
		</div>
	</div>
	<div id="ctHoraEvento" class='container'>
