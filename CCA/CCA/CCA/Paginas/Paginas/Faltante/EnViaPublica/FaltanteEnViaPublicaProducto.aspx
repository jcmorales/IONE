...
<!--Nombre del documento: FaltanteEnViaPublicaProducto -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'FaltanteEnViaPublicaProducto'
		};
...
function sumarMonto ()
	{
	    ...
	    var montoAproximadoenProducto = document.getElementById('txtMontoAproximadoenproducto').value;
		...
		var tmontoAproximadoenProducto= 0;
		if(montoAproximadoenProducto != '')
		 	tmontoAproximadoenProducto= parseFloat(montoAproximadoenProducto.replace('$ ','').replace(new RegExp(',', 'g'), ''));
		 	//totrosmontos= parseFloat(otrosMontos.replace('$ ','').replace(',',''));

	    resultado= tmontoAproximadoenProducto + tmontoderecuperacion + tmontodelProducto;
	    //alert(resultado);
...
<h3 id="lblFaltante/En Vía Pública/Producto">Faltante/En Vía Pública/Producto</h3>
