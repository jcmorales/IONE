...
<!--Nombre del documento: CajaSeguridadRutaTrasladoLlaves -->
...
async: false,
	...
	function obtenerDatos(identificador) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('TR_CajaSeguridad')/Items?$select= HoraOcurre,HoraFinaliza,HoraReportanProteccion,NombrePersonaReportaProteccion,PuestoPersonaReportaProteccion,Economico,Ruta,Placas,Motivo,Numero,LugarResguardo,Origen,Destino,HoraEntrega,NombreQuienRecibe,PuestoQuienRecibe,ObservacionesInformacionAdiciona,NombreReporte,NumeroReporte,Title&$orderby = ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
	...
	alert('No se puede continuar porque el campo * Hora de entrega está vacío');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Nombre de la persona que recibe está vacío');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Puesto de la persona que recibe está vacío');
			return false;
		}else{
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'CajaSeguridadRutaTrasladoLlaves'
		};
...
<h3 id="lblCajaSeguridadRutaTrasladoLlaves">CajaSeguridadRutaTrasladoLlaves</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblNombredequienrecibe'  >* Nombre de la persona que recibe</label>
				<input class='form-control' idvariabledepende ='Nombredequienrecibe' maxlength='50' id='txtNombredequienrecibe' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblPuestodequienrecibe'  >* Puesto de la persona que recibe</label>
