...
EliminarDatosRutas($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarDatosB(datos, clientContext) {
		...
		guardarReporteRutasB(datos[3][i], info.Identificador, info.NumeroReporte, info.Estatus, clientContext);
		}
	...
	function guardarReporteB(d, clientContext) {
		try {
			...
			oListItemDatos.set_item('DesRespaldo', datos.DesRespaldo);
	...
	function gotAccount(sender, args) {
		...
		var cRespaldo= document.getElementById('LstRespaldo_');
		llenarObjSelect(cRespaldo, vRespaldo);
	}
...
async: false,
	...
	function bloquear(can_ubi, can_equi, can_per) {
		...
		$('#LstRespaldo_').prop('disabled', true);
	...
	alert('No se puede continuar porque el campo * Número de rutas está vacío');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * Monto de efectivo está vacío');
		...
		if($('#LstRespaldo_ option:selected').text() === '...' || $('#LstRespaldo_ option:selected').text() === '') {
			$('#LstRespaldo_').css('border-color', 'red');
	alert('No se puede continuar porque el campo * ¿Se dio Respaldo? está vacío');
			return false;
		}else{
			$('#LstRespaldo_').css('border-color', '#D8D8D8');
		}
		if($('#txtdescrpcionderespaldo').val() === ''){
			$('#txtdescrpcionderespaldo').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Descripción de Respaldo está vacío');
			return false;
		}else{
	...
	function obtener() {
		...
		var e = {
			...
			'Respaldo': $('#LstRespaldo_ option:selected').text(),
			'DesRespaldo': $('#txtdescrpcionderespaldo').val(),
	...
	function colocar(datos) {
		...
		vRespaldo = datos.Respaldo;
		$('#txtdescrpcionderespaldo').val(datos.DesRespaldo),
...
var resultado="";
	    ...
	    resultado= tAcumulacionMonto + tmontoefectivo;
	    //alert(resultado);
...
<h3 id="lblCobroSeguro">CobroSeguro</h3>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		<label class='control-label' id= 'lblnumeroderutas'  >* Número de rutas</label>
		<input class='form-control numero' idvariabledepende ='numeroderutas' maxlength='4' id='txtnumeroderutas' type='text'  />
	</div>
			</div>
		</div>
	</section>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control moneda' onblur="sumarMonto()" idvariabledepende ='AcumulacionMonto' maxlength='25' id='txtAcumulacionMonto' type='text'  disabled/>
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblRespaldo'  >* ¿Se dio Respaldo?</label>
				<select class='form-control' id='LstRespaldo_'   >
					<option></option>
				</select>
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lbldescrpcionderespaldo'  >* Descripción de Respaldo</label>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMontoTotal'>* Monto total</label>
