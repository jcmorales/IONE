...
<!--Nombre del documento: CCTVControlAccesosElectronicosCCTVFallas -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'CCTVControlAccesosElectronicosCCTVFallas'
		};
		var varEquipos = {};
		var varEquiposs = [];
		for(var i = 1; i <= $('#hdncontador_Equipos').val(); i++) {
...
<h3 id="lblCCTVControlAccesosElectronicosCCTVFallas">CCTVControlAccesosElectronicosCCTVFallas</h3>
