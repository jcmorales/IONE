...
<!--Nombre del documento: AlarmaFallas -->
...
EliminarDatosArea($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarDatosB(datos, clientContext) {
		...
		guardarReporteEquiposB(datos[1][i], info.Identificador, info.NumeroReporte, info.Estatus, clientContext);
		}
