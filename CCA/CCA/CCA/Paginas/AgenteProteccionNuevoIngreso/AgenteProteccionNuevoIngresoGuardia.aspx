...
EliminarDatosPersonasInvolucradas($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarReporteB(d, clientContext) {
		try {
			...
			oListItemDatos.set_item('CamisolaCantidad', datos.CamisolaCantidad);
			oListItemDatos.set_item('PantalonTacticoCantidad', datos.PantalonTacticoCantidad);
			oListItemDatos.set_item('PlayeraInteriorCantidad', datos.PlayeraInteriorCantidad);
			oListItemDatos.set_item('BotasCantidad', datos.BotasCantidad);
			oListItemDatos.set_item('GorraCantidad', datos.GorraCantidad);
...
async: false,
	...
	function bloquear(can_ubi, can_equi, can_per) {
		...
		$('#txtCamisola').prop('disabled', true);
		$('#txtPantalonTactico').prop('disabled', true);
		$('#txtPlayeraInterior').prop('disabled', true);
		$('#txtBotas').prop('disabled', true);
		$('#txtGorra').prop('disabled', true);
	...
	alert('No se puede continuar porque el campo * Fecha de entrega está vacío');
		...
		if($('#txtCamisola').val() === ''){
			$('#txtCamisola').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Camisola está vacío');
			return false;
		}else{
			$('#txtCamisola').css('border-color', '#D8D8D8');
		}
		if($('#txtPantalonTactico').val() === ''){
			$('#txtPantalonTactico').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Pantalón táctico está vacío');
			return false;
		}else{
			$('#txtPantalonTactico').css('border-color', '#D8D8D8');
		}
		if($('#txtPlayeraInterior').val() === ''){
			$('#txtPlayeraInterior').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Playera interior está vacío');
			return false;
		}else{
			$('#txtPlayeraInterior').css('border-color', '#D8D8D8');
		}
		if($('#txtBotas').val() === ''){
			$('#txtBotas').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Botas está vacío');
			return false;
		}else{
			$('#txtBotas').css('border-color', '#D8D8D8');
		}
		if($('#txtGorra').val() === ''){
			$('#txtGorra').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Gorra está vacío');
			return false;
		}else{
			$('#txtGorra').css('border-color', '#D8D8D8');
		}
		if($('#txtotrosunif').val() === ''){
	...
	function obtener() {
		...
		var e = {
			...
			'CamisolaCantidad': $('#txtCamisola').val(),
			'PantalonTacticoCantidad': $('#txtPantalonTactico').val(),
			'PlayeraInteriorCantidad': $('#txtPlayeraInterior').val(),
			'BotasCantidad': $('#txtBotas').val(),
			'GorraCantidad': $('#txtGorra').val(),
			...
			'NombreReporte':'AgenteProteccionNuevoIngresoGuardia'
		};
	...
	function colocar(datos) {
		...
		$('#txtCamisola').val(datos.CamisolaCantidad),
		$('#txtPantalonTactico').val(datos.PantalonTacticoCantidad),
		$('#txtPlayeraInterior').val(datos.PlayeraInteriorCantidad),
		$('#txtBotas').val(datos.BotasCantidad),
		$('#txtGorra').val(datos.GorraCantidad),
