...
<!--Nombre del documento: CCTVControlAccesosElectronicosEsclusaFallas -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'CCTVControlAccesosElectronicosEsclusaFallas'
		};
		var varEquipos = {};
		var varEquiposs = [];
		for(var i = 1; i <= $('#hdncontador_Equipos').val(); i++) {
...
<h3 id="lblCCTVControlAccesosElectronicosEsclusaFallas">CCTVControlAccesosElectronicosEsclusaFallas</h3>
