...
<!--Nombre del documento: ProteccionSatelitalGPSFallas -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'ProteccionSatelitalGPSFallas'
		};
		var varEquipos = {};
		var varEquiposs = [];
		for(var i = 1; i <= $('#hdncontador_Equipos').val(); i++) {
...
<h3 id="lblProteccionSatelitalGPSFallas">ProteccionSatelitalGPSFallas</h3>
