...
<!--Nombre del documento: ExtravioDentroUOProducto -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'ExtravioDentroUOProducto'
		};
...
function sumarMonto ()
	{
	    var resultado="";
	    var montodeEfectivo = document.getElementById('txtMontodelProducto').value;
	    ...
	    resultado= tmontoefectivo + tmontoderecuperacion + toAproximadodelProducto;
	    //alert(resultado);
...
<h3 id="lblExtravío/DentroUO/Producto">Extravío/DentroUO/Producto</h3>
