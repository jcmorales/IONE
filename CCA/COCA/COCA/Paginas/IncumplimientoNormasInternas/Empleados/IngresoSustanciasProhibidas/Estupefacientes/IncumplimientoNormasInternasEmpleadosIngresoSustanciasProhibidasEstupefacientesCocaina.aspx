...
<!--Nombre del documento: IncumplimientoNormasInternasEmpleadosIngresoSustanciasProhibidasEstupefacientesCocaina -->
...
EliminarDatosVehiculo($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarDatosB(datos, clientContext) {
		...
		guardarReporteVehiculoB(datos[3][i], info.Identificador, info.NumeroReporte, info.Estatus, clientContext);
		}
	...
	function gotAccount(sender, args) {
		...
		var cRespaldo= document.getElementById('Respaldo_');
		llenarObjSelecct(cRespaldo, vRespaldo);
...
async: false,
	...
	function validarCampos() {
		...
		if($('#LstRespaldo_ option:selected').text() === '...') {
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'IncumplimientoNormasInternasEmpleadosIngresoSustanciasProhibidasEstupefacientesCocaina'
		};
...
<h3 id="lblIncumplimientoNormasInternasEmpleadosIngresoSustanciasProhibidasEstupefacientesCocaina">IncumplimientoNormasInternasEmpleadosIngresoSustanciasProhibidasEstupefacientesCocaina</h3>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		...
		<input class='form-control text' idvariabledepende ='Ruta' maxlength='10' id='txtRuta' type='text'  />
	</div>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		...
		<input class='form-control text' idvariabledepende ='Economico' maxlength='10' id='txtEconomico' type='text'  />
	</div>
			</div>
		</div>
	</section>
