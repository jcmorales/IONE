...
<!--Nombre del documento: PerdidasPatrimonialesRoboHerramientasTrabajo -->
...
async: false,
	...
	function obtenerDatos(identificador) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('TR_PerdidasPatrimoniales')/Items?$select= HoraOcurre,HoraFinaliza,HoraReportanProteccion,NombrePersonaReportaProteccion,PuestoPersonaReportaProteccion,NoAveriguacionPrevia,Detenidos,Calle,Numero,Colonia,MunicipioDelegacion,Estado,CodigoPostal,MontoEfectivo,MontoRecuperacion,MontoAproximadoEfectivo,OtrosMontos,MontoTotal,ObservacionesInformacionAdiciona,NombreReporte,NumeroReporte,Title&$orderby = ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'PerdidasPatrimonialesRoboHerramientasTrabajo'
		};
...
<h3 id="lblPerdidasPatrimonialesRoboHerramientasTrabajo">PerdidasPatrimonialesRoboHerramientasTrabajo</h3>
