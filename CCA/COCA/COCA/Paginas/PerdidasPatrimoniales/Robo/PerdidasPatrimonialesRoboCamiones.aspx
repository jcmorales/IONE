...
<!--Nombre del documento: PerdidasPatrimonialesRoboCamiones -->
...
async: false,
	...
	function obtenerProducto(identificador, campo) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('DN_Producto')/Items?$select= Producto,Cantidad,Total&$orderby=ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'PerdidasPatrimonialesRoboCamiones'
		};
...
<h3 id="lblPerdidasPatrimonialesRoboCamiones">PerdidasPatrimonialesRoboCamiones</h3>
