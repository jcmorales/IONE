...
<head runat="server">
<!--Documento generado de manera din�mica por SPFormsEasy -->
<!--Nombre del documento: PerdidasPatrimonialesSociopoliticoRutaMaestros -->
...
EliminarDatosClientes($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarReporteB(d, clientContext) {
		try {
			...
			oListItemDatos.set_item('MontoAproximadoEfectivo', datos.MontoAproximadoEfectivo);
	...
	function gotAccount(sender, args) {
		...
		if (pais == "BR") {
			...
			if (pais == "PH") {
				TraducirIdiomaNP("Ingl�s", URLSitio, "Incidencias.aspx");
			}else {
				TraducirIdiomaNP("Espa�ol", URLSitio, "Incidencias.aspx");
			}
		}
		...
		var cStatusCaja= document.getElementById('LstStatusCaja_');
		llenarObjSelect(cStatusCaja, vStatusCaja);
		var cReincidente= document.getElementById('LstReincidente_');
		llenarObjSelect(cReincidente, vReincidente);
	}
...
async: false,
	...
	function obtenerClientes(identificador, campo) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('DN_Cliente')/Items?$select= Cliente,HorarioPresentoConCliente&$orderby=ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
...
async: false,
	...
	function obtenerDatos(identificador) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('TR_PerdidasPatrimoniales')/Items?$select= HoraOcurre,HoraFinaliza,HoraReportanProteccion,NombrePersonaReportaProteccion,PuestoPersonaReportaProteccion,Economico,Ruta,Placas,Motivo,NoDelincuentes,NoAveriguacionPrevia,Detenidos,StatusCaja,Calle,Numero,Colonia,MunicipioDelegacion,Estado,CodigoPostal,Reincidente,MontoEfectivo,MontoRecuperacion,MontoAproximadoEfectivo,OtrosMontos,MontoAproximadoProducto,MontoTotal,LugarResguardo,ObservacionesInformacionAdiciona,NombreReporte,NumeroReporte,Title&$orderby = ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
	...
	function bloquear(can_ubi, can_equi, can_per) {
		...
		$('#txtMontoAproximadoenEfectivo').prop('disabled', true);
	...
	function validarCampos() {
		if($('#txtHoraOcurre').val() === ''){
			$('#txtHoraOcurre').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Hora en que ocurre est� vac�o');
			return false;
		}else{
			$('#txtHoraOcurre').css('border-color', '#D8D8D8');
		}
		if($('#txtHoraFinaliza').val() === ''){
			$('#txtHoraFinaliza').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Hora en que finaliza est� vac�o');
			return false;
		}else{
			$('#txtHoraFinaliza').css('border-color', '#D8D8D8');
		}
	...
	alert('No se puede continuar porque el campo * Hora en que reportan a protecci�n est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Nombre de la persona que reporta a protecci�n est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Puesto de la persona que reporta a protecci�n est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Nombre(s) persona(s) involucrada(s) est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * �rea est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * N�mero de empleado est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * Econ�mico est� vac�o');
			return false;
		}else{
			$('#txtEconomico').css('border-color', '#D8D8D8');
		}
		if($('#txtRuta').val() === ''){
			$('#txtRuta').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Ruta est� vac�o');
			return false;
		}else{
			$('#txtRuta').css('border-color', '#D8D8D8');
		}
		if($('#txtPlacas').val() === ''){
			$('#txtPlacas').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Placas est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Producto est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * Cantidad est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * Monto unitario est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * Total est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * Motivo est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Cliente est� vac�o');
				return false;
			}else{
	...
	alert('No se puede continuar porque el campo * Horario en el que se presento con el cliente est� vac�o');
				return false;
			}else{
				$('#txtHorarioPresentoCliente' + i).css('border-color', '#D8D8D8');
			}
		}
		if($('#txtNoDelincuentes').val() === ''){
			$('#txtNoDelincuentes').css('border-color', 'red');
	alert('No se puede continuar porque el campo N�mero de Delincuentes est� vac�o');
			return false;
		}else{
			$('#txtNoDelincuentes').css('border-color', '#D8D8D8');
		}
		if($('#txtNumerodeAveriguacionPrevia').val() === ''){
			$('#txtNumerodeAveriguacionPrevia').css('border-color', 'red');
	alert('No se puede continuar porque el campo * N�mero de averiguaci�n previa est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Detenidos est� vac�o');
			return false;
		}else{
			$('#LstDetenidos_').css('border-color', '#D8D8D8');
		}
		if($('#LstStatusCaja_ option:selected').text() === '...' || $('#LstStatusCaja_ option:selected').text() === '') {
			$('#LstStatusCaja_').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Status de caja est� vac�o');
			return false;
		}else{
			$('#LstStatusCaja_').css('border-color', '#D8D8D8');
		}
		if($('#txtCalle').val() === ''){
			$('#txtCalle').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Calle est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * N�mero est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Colonia est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Municipio/Delegaci�n est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Estado  est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * C�digo postal est� vac�o');
			return false;
		}else{
			$('#txtCodigoPostal').css('border-color', '#D8D8D8');
		}
		if($('#LstReincidente_ option:selected').text() === '...' || $('#LstReincidente_ option:selected').text() === '') {
			$('#LstReincidente_').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Reincidente est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Monto de efectivo est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Monto de recuperaci�n est� vac�o');
			return false;
		}else{
			$('#txtMontodeRecuperacion').css('border-color', '#D8D8D8');
		}
		if($('#txtMontoAproximadoenEfectivo').val() === ''){
			$('#txtMontoAproximadoenEfectivo').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Monto aproximado en efectivo est� vac�o');
			return false;
		}else{
			$('#txtMontoAproximadoenEfectivo').css('border-color', '#D8D8D8');
		}
		if($('#txtOtrosMontos').val() === ''){
			$('#txtOtrosMontos').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Otros montos est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Monto aproximado en producto est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Lugar de resguardo est� vac�o');
			return false;
		}else{
	...
	alert('No se puede continuar porque el campo * Observaciones/Informaci�n adicional est� vac�o');
			return false;
		}else{
	...
	function obtener() {
		...
		var e = {
			...
			'MontoAproximadoEfectivo': $('#txtMontoAproximadoenEfectivo').val(),
			...
			'NombreReporte':'PerdidasPatrimonialesSociopoliticoRutaMaestros'
		};
	...
	function colocar(datos) {
		...
		vReincidente = datos.Reincidente;
		$('#txtMontodeEfectivo').val(datos.MontoEfectivo),
		$('#txtMontodeRecuperacion').val(datos.MontoRecuperacion),
		$('#txtMontoAproximadoenEfectivo').val(datos.MontoAproximadoEfectivo),
...
var SelectedItem;
	...
	{
	    var resultado="";
	    var montodeEfectivo = document.getElementById('txtMontodeEfectivo').value;
	    var montodeRecuperacion = document.getElementById('txtMontodeRecuperacion').value;
   	    ...
   	    var montoAproximadoenEfectivo = document.getElementById('txtMontoAproximadoenEfectivo').value;	    
	    var otrosMontos = document.getElementById('txtOtrosMontos').value;	   
	    
	    var tmontoefectivo = 0;
		if(montodeEfectivo != '')
			tmontoefectivo = parseFloat(montodeEfectivo.replace('$ ','').replace(new RegExp(',', 'g'), ''));
		 	//tmontoefectivo = parseFloat(montodeEfectivo.replace('$ ','').replace(',',''));
		...
		if(montodeRecuperacion != '')
		 ...
		 var totrosmontos= 0;
		if(otrosMontos != '')
			totrosmontos= parseFloat(otrosMontos.replace('$ ','').replace(new RegExp(',', 'g'), ''));
		...
		if(montoAproximadodelProducto != '')
		 ...
		 var toAproximadoenEfectivo = 0;
		if(montoAproximadoenEfectivo != '')
			toAproximadoenEfectivo = parseFloat(montoAproximadoenEfectivo .replace('$ ','').replace(new RegExp(',', 'g'), ''));
				
		 	
	    resultado= tmontoefectivo + tmontoderecuperacion + totrosmontos + toAproximadodelProducto + toAproximadoenEfectivo;
	    //alert(resultado);
...
<h3 id="lblPerdidasPatrimonialesSociopoliticoRutaMaestros">PerdidasPatrimonialesSociopoliticoRutaMaestros</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label  id='lblHoraAvisanProteccion'>* Hora en que reportan a protecci�n</label>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblNombredelapersonaquereportaaproteccion'  >* Nombre de la persona que reporta a protecci�n</label>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblPuestodelapersonaquereportaaproteccion'  >* Puesto de la persona que reporta a protecci�n</label>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		<label class='control-label' id= 'lblAreaPersonasInvolucradas'  >* �rea</label>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		<label class='control-label' id= 'lblNumeroEmpleadoPersonasInvolucradas'  >* N�mero de empleado</label>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblEconomico'  >* Econ�mico</label>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control' idvariabledepende ='Ruta' maxlength='10' id='txtRuta' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		...
		<input class='form-control text' idvariabledepende ='Cliente' maxlength='50' id='txtCliente' type='text'  />
	</div>

	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		<label class='control-label' id= 'lblHorarioPresentoCliente'  >* Horario en el que se presento con el cliente</label>
		<input class='form-control tiempo' idvariabledepende ='HorarioPresentoCliente' maxlength='5' id='txtHorarioPresentoCliente' type='text'  />
	</div>
			</div>
		</div>
	</section>
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblNoDelincuentes'  >N�mero de Delincuentes</label>
				<input class='form-control numero' idvariabledepende ='NoDelincuentes' maxlength='4' id='txtNoDelincuentes' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblNumerodeAveriguacionPrevia'  >* N�mero de averiguaci�n previa</label>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblStatusCaja'  >* Status de caja</label>
				<select class='form-control' id='LstStatusCaja_'   >
					<option></option>
				</select>
			</div>
		</div>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblNumeroDireccion'  >* N�mero</label>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMunicipio'  list='dtlMun' onfocus='getMun();'>* Municipio/Delegaci�n</label>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblCodigoPostal'  >* C�digo postal</label>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control moneda' onblur="sumarMonto()" idvariabledepende ='MontodeEfectivo' maxlength='25' id='txtMontodeEfectivo' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMontodeRecuperacion'  >* Monto de recuperaci�n</label>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMontoAproximadoenEfectivo'  >* Monto aproximado en efectivo</label>
				<input class='form-control moneda' onblur="sumarMonto()" idvariabledepende ='MontoAproximadoenEfectivo' maxlength='25' id='txtMontoAproximadoenEfectivo' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblOtrosMontos'  >* Otros montos</label>
				<input class='form-control moneda' onblur="sumarMonto()" idvariabledepende ='OtrosMontos' maxlength='25' id='txtOtrosMontos' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-12 col-md-12 col-lg-12 col-xl-12 form-group'>
				<label class='obligatorio etiquetaM control-label'  >* Observaciones/Informaci�n adicional</label>
	...
	<span id="lblAgregarExito" style="display:none">El reporte se ha agregado con �xito</span>
