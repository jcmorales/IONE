...
<!--Nombre del documento: ExtorsionUOOtras -->
...
async: false,
	...
	function obtenerDatos(identificador) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('TR_Extorsion')/Items?$select= HoraOcurre,HoraFinaliza,HoraReportanProteccion,NombrePersonaReportaProteccion,PuestoPersonaReportaProteccion,NombreQuienProporcionaApoyo,PuestoQuienProporcionaApoyo,TipoArma,EspecificaArma,NoAveriguacionPrevia,TipoAsesoria,ObservacionesInformacionAdiciona,NombreReporte,NumeroReporte,Title&$orderby = ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'ExtorsionUOOtras'
		};
...
<h3 id="lblExtorsión/UO/Otras">Extorsión/UO/Otras</h3>
