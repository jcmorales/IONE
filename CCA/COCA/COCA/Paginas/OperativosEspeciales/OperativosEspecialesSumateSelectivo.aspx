...
<!--Nombre del documento: OperativosEspecialesSumateSelectivo -->
...
EliminarDatosArea($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function guardarReporteB(d, clientContext) {
		try {
			...
			oListItemDatos.set_item('Articulo', datos.Articulo);
...
async: false,
	...
	function bloquear(can_ubi, can_equi, can_per) {
		...
		$('#txtArticulo').prop('disabled', true);
	...
	alert('No se puede continuar porque el campo * Motivo está vacío');
		...
		if($('#txtArticulo').val() === ''){
			$('#txtArticulo').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Artículo está vacío');
			return false;
		}else{
			$('#txtArticulo').css('border-color', '#D8D8D8');
		}
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'OperativosEspecialesSumateSelectivo'
		};
	...
	function colocar(datos) {
		...
		$('#txtArticulo').val(datos.Articulo),
...
<h3 id="lblOperativosEspecialesSumateSelectivo">OperativosEspecialesSumateSelectivo</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblArticulo'  >* Artículo</label>
				<input class='form-control' idvariabledepende ='Articulo' maxlength='50' id='txtArticulo' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
