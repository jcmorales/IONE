...
<!--Nombre del documento: FallasEnergiaElectricaExterna -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'FallasEnergiaElectricaExterna'
		};
		var varArea = {};
		var varAreas = [];
		for(var i = 1; i <= $('#hdncontador_Area').val(); i++) {
...
<h3 id="lblFallas Energía Electrica/Externa">Fallas Energía Electrica/Externa</h3>
