...
<!--Nombre del documento: IncumplimientoNormasInternasEmpleadosCobroSimultaneo -->
...
async: false,
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'IncumplimientoNormasInternasEmpleadosCobroSimultaneo'
		};
...
<h3 id="lblIncumplimientoNormasInternasEmpleadosCobroSimultaneo">IncumplimientoNormasInternasEmpleadosCobroSimultaneo</h3>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		...
		<input class='form-control moneda' idvariabledepende ='MontoCliente' maxlength='50' id='txtMontoCliente' type='text'/>
	</div>
			</div>
		</div>
	</section>
