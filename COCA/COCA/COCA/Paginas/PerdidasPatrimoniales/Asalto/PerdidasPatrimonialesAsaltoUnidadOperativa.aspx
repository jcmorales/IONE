	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control moneda' idvariabledepende ='MontoAproximadoenEfectivo' maxlength='25' id='txtMontoAproximadoenEfectivo' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control moneda' idvariabledepende ='MontodelProducto' maxlength='25' id='txtMontodelProducto' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMontoAproximadoenproducto'  >* Monto aproximado en producto</label>
				<input class='form-control moneda' idvariabledepende ='MontoAproximadoenproducto' maxlength='25' id='txtMontoAproximadoenproducto' type='text'  />
			</div>
		</div>
	</div>
	<div id="ctHoraEvento" class='container'>
